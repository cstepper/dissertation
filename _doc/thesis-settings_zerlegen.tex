...
\newcommand{\myName}{Christoph Stepper}
\newcommand{\myTitle}{Digital Aerial Photogrammetry for estimating Forest Inventory Attributes 
--- applications for Spatial and Temporal Analysis}
\newcommand{\mySubTitle}{Dissertation}
\newcommand{\myLocation}{Freising}
\newcommand{\myGroup}{Wissenschaftszentrum Weihenstephan\\
	Technische Universität München}
\newcommand{\myUrl}{\url{http://www.lwf.bayern.de/}}
\newcommand{\myTime}{March 2016}
...
% ********************************************************************
% copied from classicthesis-config.tex
...
\usepackage{varioref}
\usepackage[style=authoryear-comp,hyperref,natbib]{biblatex}
\usepackage{chngpage}
\usepackage{calc}
\usepackage{listings}
\usepackage{graphicx}
...
% TUMblau --> Pantone 300C
\usepackage[usenames, dvipsnames]{xcolor}
%\definecolor{tumblau}{cmyk}{0.9, 0.4, 0, 0.22}
\definecolor{tumblau}{cmyk}{0.99, 0.5, 0, 0.22}
...
% \hyphenation{words} is to define all words were automatic hyphenation is not working properly
\hyphenation{pho-to-gram-me-try boot-strap
	}
